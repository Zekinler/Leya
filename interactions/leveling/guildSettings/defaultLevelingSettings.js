...
module.exports = {
	customId: 'defaultlevelingsettings',
	async execute(interaction, db, client) {
		...
		databaseGuild.settings.levelingSettings = {
			...
			levelRewards: databaseGuild.settings.levelingSettings.levelRewards,
		};
		...
		await interaction.followUp({ content: 'Successfully reset the leveling settings back to default', ephemeral: true });
	},
};